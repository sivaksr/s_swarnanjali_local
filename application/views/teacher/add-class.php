    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
              ...
              <li class="<?php if(isset($tab) && $tab==''){ echo "active";} ?>"><a href="#tab_1" data-toggle="tab">Add Teacher Modules Wise Class
</a></li>
             ...
             <div class="tab-pane active<?php if(isset($tab) && $tab==''){ echo "active";} ?>" id="tab_1">
                                       <form id="defaultForm" method="POST" class="" action="<?php echo base_url('teachermoduleswise/addpost');?>">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class=" control-label">Modules</label>
                                                        <div class="">
														<select class="form-control" id="modules_name" name="modules_name" >
											...
											<?php } ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="">
														<input class="form-control" id="class" name="class" placeholder="Enter class">
                                                        </div>
                                                    </div>
                                                </div>
