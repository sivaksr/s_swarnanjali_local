...
.razorpay-payment-button{
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Student Bus Payment  
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"> Student Bus Payment </li>
      </ol>
    </section>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step1">
                        ...
                        <table class="table table-bordered">
							...
							<tbody>
							  <tr>
								<th>Name</th>
								<td><?php echo isset($student_details['username'])?$student_details['username']:''; ?></td>
							  </tr>
							  <tr>
								<th>Admission Number</th>
								<td><?php echo isset($student_details['roll_number'])?$student_details['roll_number']:''; ?></td>
							  </tr>
							  <tr>
								<th>Class</th>
								<td><?php echo isset($student_details['name'])?$student_details['name']:''; ?>&nbsp;&nbsp;<?php echo isset($student_details['section'])?$student_details['section']:''; ?></td>
							  </tr>
							  <tr>
								<th>Partent Name</th>
							  ...
							  <tr>
								<th>Partent Email</th>
								<td><?php echo isset($student_details['parent_email'])?$student_details['parent_email']:''; ?></td>
							  </tr>
							 <tr>
								<th>Address</th>
								<td>
                        ...
                        <table class="table table-bordered">
							...
							<tbody>
							  ...
							  <tr>
								...
								<td><?php echo (($list['total_amount'])-($list['pay_amount'])); ?></td>
							  </tr>
							...
							<?php } ?>
							 ...
							 <tr>							
								<th>Toatl</th>
								<th><?php echo isset($last_payment_details[0]['total_amount'])?$last_payment_details[0]['total_amount']:''; ?></th>
								<th><?php echo isset($total_pay)?$total_pay:''; ?></th>
								<th><?php echo isset($last_payment_details[0]['total_amount'])?$last_payment_details[0]['total_amount']-$total_pay:''; ?></th>
                    ...
                    <div class="tab-pane active" role="tabpanel" id="step2">
                        ...
                        <table class="table table-bordered">
						  ...
						  <div class="clearfix">&nbsp;</div>
						   <form  id="paymentform" name="paymentform" action="<?php echo base_url('payment/bus_payment_success'); ?>" method="POST">
											 <?php $csrf = array(
