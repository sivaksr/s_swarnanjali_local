            ...
            <tr class="information">
                <td colspan="2">
                    <table>
                        <tr>
                            <td>
							 <h2 style="text-align:center;">Student Fee Payment</h1>	
                             <div>
							 ...
							 <div>
								<strong>School Name:  </strong> <?php echo isset($school_details['scl_bas_name'])?$school_details['scl_bas_name']:''; ?>,
							 </div> 
							 <div>
