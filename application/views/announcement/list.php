...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Send SMS For Students List
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Send SMS For Students List</li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php $cnt=1; foreach($student_list as $list){?>
							<tr>
							<td><?php echo $cnt;?></td>
							<td><?php echo isset($list['sms'])?$list['sms']:'' ?></td>
							<td><?php echo isset($list['name'])?$list['name']:'' ?><?php echo isset($list['section'])?$list['section']:'' ?></td>	 
							<td>
							<?php if(isset($list['students'])&& count($list['students'])>0){?>
							<?php foreach($list['students'] as $lis) { ?>
							...
							<td><?php echo isset($list['msg'])?$list['msg']:'' ?></td>	 
